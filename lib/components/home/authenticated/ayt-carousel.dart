...
class AytCarousel extends StatefulWidget {
  const AytCarousel({super.key});

  @override
  State<AytCarousel> createState() => _AytCarouselState();
}

class _AytCarouselState extends State<AytCarousel> {
  List<Ders> dersler = [];
                            ...
                            child: Card(
                                ...
                                Container(
                                    child: Column(
                                      ...
                                      Container(
                                        child: Text(
                                            "Son 5 AYT denemesi ${dersler[index].dersAdi} dersi için",
                                            style: TextStyle(
                                                fontSize: 16,
                                              ...
                                              ? [
                                                  Container(
                                                      ...
                                                      alignment:
                                                          Alignment.center,
                                                      child: Text(
                                                        "${dersler[index].dersAdi} dersinde yanlış yaptığınız konu bulunmamaktadır.",
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: TextStyle(
                                                            fontSize: 18,
