...
class _TytCreateState extends State<TytCreate> {
  ...
  void initState() {
    ...
    signalRService!.on(HubUrls.TytHub.url,ReceiveFunctions.TytAddedMessage, (message) {
      final parsedMessage = message is List && message.isNotEmpty ? message[0] : message;
  ...
  Future<void> createTyt() async {
    ...
    try {
      ...
      // successToast("Başarılı", "TYT denemesi başarıyla eklendi.",Navigator.of(context).context);
      // setState(() {
      //   yanlisKonularId.clear();
      //   bosKonularId.clear();

      //   // DogruControllers ve YanlisControllers yapılarını 0'a eşitle
  ...
  void _onSearchChanged(String value) {
    ...
    _debounce = Timer(const Duration(milliseconds: 500), () async {
      ...
      try {
        ...
        errorToast("Hata", 'Konular alınırken bir hata oluştu.', Navigator.of(context).context);
      }
      isLoadingKonu.value = false;
    });
  }
                        ...
                        Expanded(
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: NumberInput(
                                  controller: dogruControllers[item.dersAdi],
                                  min: 0,
                        ...
                        Expanded(
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: NumberInput(
                                  controller: yanlisControllers[item.dersAdi],
                                  min: 0,
                                  max: item.dersAdi == "Türkçe" ||
                                          item.dersAdi == "Matematik"
                                      ? 40
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                          ...
                                          child: TextField(
                                            placeholder: Text('Konu arayın...'),
                                            trailing: StatedWidget.builder(
                                      ...
                                      Expanded(
                                        ...
                                        return ValueListenableBuilder<List<ListKonu>>(
                                          valueListenable: konularNotifier,
                                          builder: (context,konular,_){
                                            if(isLoadingKonu.value){
                                              return Center(
                                                child: 
