...
class _GirisYapScreenState extends State<GirisYapScreen> {
  ...
  void submitLogin() {
    login(_usernameOrEmail.text, _password.text, callBackFunction: () {
      context.go("/");
        ...
        child: Column(
          children: [
            FormField<String>(
              ...
              label: Text("Email veya kullanıcı adı",
                style: TextStyle(color: themeData.colorScheme.foreground,fontSize: 14,),),
            ...
            TextButton(
              ...
              child: Text("Şifremi Unuttum",style:TextStyle(color: themeData.colorScheme.foreground,fontSize: 16,),),
            ),
            Container(
